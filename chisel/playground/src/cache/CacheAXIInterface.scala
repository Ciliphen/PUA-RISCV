...
class CacheAXIInterface extends Module {
  ...
  io.axi.ar.bits.len   := Mux(ar_id, io.dcache.ar.bits.len, io.icache.ar.bits.len)
  ...
  io.icache.ar.ready   := !ar_id && io.axi.ar.ready
  io.dcache.ar.ready   := ar_id && io.axi.ar.ready
  // mux ar }
