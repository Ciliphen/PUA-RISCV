...
![图 9.3 五级流水线CPU](实现R型运算类指令的理想流水线设计实验.assets/image-20240108174346298.png)
...
![图 9.6 取指单元](实现R型运算类指令的理想流水线设计实验.assets/image-20240109155256358.png)
...
因为取指单元只会对内存进行读操作，因此 inst_sram_en 只要在 reset 无效时使能即可，而 inst_sram_wen 应该恒为低电平。图 9.6 展示了取指单元的结构。图。
...
![图 9.7 指令队列](实现R型运算类指令的理想流水线设计实验.assets/image-20240109153542526.png)
...
![图 9.8 R型指令格式](实现R型运算类指令的理想流水线设计实验.assets/image-20240109144722861.png)
...
![图 9.9 R型运算指令](实现R型运算类指令的理想流水线设计实验.assets/image-20240109161753616.png)

![image-20240109170840829](实现R型运算类指令的理想流水线设计实验.assets/image-20240109170840829.png)
...
![图 9.10 ADD指令的定义](实现R型运算类指令的理想流水线设计实验.assets/image-20240107213027949.png)
...
![图 9.11 译码单元](实现R型运算类指令的理想流水线设计实验.assets/image-20240109183759396.png)
